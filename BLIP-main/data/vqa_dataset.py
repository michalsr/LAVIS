...
class vqa_dataset(Dataset):
    def __init__(self, transform, ann_root, vqa_root, vg_root, train_files=[], split="train"):
        self.annotation = json.load(open('/shared/rsaas/michal5/LAVIS/contrast_caption_small.json','r'))['annotations']
        #self.split = split        
    ...
    def __getitem__(self, index):    
        ...
        updated_id = str(ann['image_id']).rjust(12,'0')
         
        image_path = f'/data/michal5/coco/images/train2017/{updated_id}.jpg'
        # if ann['dataset']=='vqa':
        ...
        return image, ann['question'], ann['answer']     
